...
\inp{Lemma a (P Q:Prop): $(P\rightarrow  Q) \rightarrow (not P \lor Q)$.
}

We of course first use implication intros by applyiong
\inp{Assume (P ? Q) then prove ((not P) ? Q).}

and get:

\coq{P Q:Prop\\Hyp: P\rightarrow Q}{not P \lor Q}
...
\infer{Q}{\begin{array}{l}Q\\ P \rightarrow Q \end{array}}
